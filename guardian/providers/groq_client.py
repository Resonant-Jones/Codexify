...
class GroqChatClient:
    ...
    def stream(self, prompt: str, model: str = 'llama-3.1-70b-versatile') -> Iterator[str]:
        ...
        with requests.post(self.api_url, headers=headers, json=body, timeout=60, stream=True) as resp:
            resp.raise_for_status()
