...
from ..tts_service import TTSProvider, AuthenticationError, SynthesisError, VoiceNotFoundError
...
class GoogleProvider(TTSProvider):
    ...
    def __init__(self, credentials_path: Optional[str] = None):
        ...
        try:
            ...
            raise AuthenticationError(f"Failed to initialize Google Cloud TTS client: {str(e)}")
