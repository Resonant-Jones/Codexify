    ...
    def _build_phase2a_plan(
        ...
        *,
        ...
        return {
            ...
            "purpose": (
                "Normalize the selected user turn into a work-scoped "
                "coding-agent task summary."
            ),
            "in_scope": [
                "selected source message content",
