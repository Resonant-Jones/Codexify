...
class SystemInitializer:
    ...
    async def get_system_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                'status': 'healthy' if status['health_status'] == 'nominal' else 'unhealthy',
...
class ThreadspaceSystem:
    ...
    def _check_system_health(self) -> Dict[str, Any]:
        ...
        if (thread_health['status'] == 'error' or
            memory_status == 'error' or
            any(h['status'] == 'error' for h in plugin_health.values())):
            status = 'error'
        elif (thread_health['status'] == 'warning' or
              memory_status == 'warning' or
              any(h['status'] == 'warning' for h in plugin_health.values())):
            status = 'warning'
        else:
            status = 'nominal'
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'startup_time': self.startup_timestamp.isoformat() 
                          if self.startup_timestamp else None,
            'health_status': self.health_status,
            'uptime': str(datetime.utcnow() - self.startup_timestamp)
                     if self.startup_timestamp else None,
            'components': {
