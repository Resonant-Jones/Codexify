...
def main() -> None:
    ...
    build_parser = subparsers.add_parser(
        'build-companion',
        help='Launch Imprint Zero companion creation flow'
    )
    
    list_companions_parser = subparsers.add_parser(
        'list-companions',
        help='List saved companions'
    )
    
    deploy_parser = subparsers.add_parser(
        'deploy-companion',
        help='Load and deploy a companion'
    )
    deploy_parser.add_argument('name', help='Companion name')
    
    delete_parser = subparsers.add_parser(
        'delete-companion',
        help='Delete a companion profile'
    )
    ...
    if args.command == 'list-plugins':
        ...
        import sys
        from pathlib import Path
        script_path = Path(__file__).parent.parent.parent / 'scripts' / 'imprint_zero_flow.py'
