...
def _resolve_guest_subject(
    ...
    if guest is None:
        raise SubjectResolutionError(
            "guest identity not found or has been deleted"
        )
...
def record_heartbeat(
    ...
    *,
    ...
    if has_account:
        resolved_id, invite_id = _resolve_account_subject(session, str(user_id))
        ...
        resolved_id, invite_id = _resolve_guest_subject(session, str(guest_id))
