...
from guardian.routes.chat import get_latest_rag_trace, _rag_traces
...
async def test_context_broker_returns_trace():
    ...
    mock_vector.search.return_value = [
        {"id": "doc1", "text": "snippet1", "score": 0.9, "metadata": {"filename": "test.txt"}}
    ]
    ...
    # Mock graph context
    with patch.object(broker, "_get_graph_context", new_callable=AsyncMock) as mock_graph:
