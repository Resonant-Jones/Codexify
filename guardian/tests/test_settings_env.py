...
from guardian.config.core import Settings, get_settings_no_env, warn_if_missing_keys
...
def test_prod_gemini_accepts_either_key():
    ...
    s2 = get_settings_no_env(
        ENV="production", AI_BACKEND="gemini", GENAI_API_KEY=None, GOOGLE_API_KEY="y"
    )
