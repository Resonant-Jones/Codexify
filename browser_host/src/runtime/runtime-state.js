...
function createRuntimeState(metadata) {
  const state = {
    ...
    negotiationTransport: metadata.negotiationTransport || "deterministic_stub",
    guardianNegotiationAdapterEnabled: Boolean(metadata.guardianNegotiationAdapterEnabled),
    guardianNegotiationOrigin: metadata.guardianNegotiationOrigin || "",
    guardianNegotiationHttpStatus: null,
    negotiationCredentialPosture: "no_credential_required_local_development_negotiation",
    ...
    remoteLoadedAfterGuardianNegotiation: false,
    lastPolicyDecision: "",
    errorCode: null,
