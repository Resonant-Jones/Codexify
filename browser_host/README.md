...
and a capture-preview/ephemeral-attachment proof slice selected by ADR-054. It
...
rejection, deterministic attachment failure, and cleanup. Product and release
gates remain closed: live Guardian integration, durable persistence, packaging,
...
- No live production Guardian route, durable persistence, or supported release
  path exists; the capture/attachment path is deterministic-stub proof only.
