...
- Phase: `evening`
- Branch: `main`
- HEAD: `a7d9f8200ceba78358df9a21ef4eaffe811ce3d1`
- Worktree: dirty
- Status lines:
  - ` M frontend/src/contracts/runtimeTokens.ts`
  - ` M frontend/src/features/workspace/components/WorkspaceTabs.tsx`
...
| `audit` | 8 | `docs/audits/daily/morning/latest.json`, `docs/audits/daily/morning/latest.md`, `docs/audits/latest.json`, `docs/audits/latest.md`, `docs/audits/daily/evening/latest.json`, `docs/audits/daily/evening/latest.md`, `docs/audits/daily/evening/2026-03-30-audit.json`, `docs/audits/daily/evening/2026-03-30-audit.md` |
...
| `unknown` | 5 | `backend/rag/embedder.py`, `guardian/cognition/prompts.py`, `guardian/core/chat_completion_service.py`, `guardian/context/broker.py`, `prompts.py` |
