...
- Date: 2026-03-31
- Phase: `morning`
- Branch: `codex/add-workspace-shell-state`
- HEAD: `8228f4f284bf64531de159afd92b905641cba841`
- Worktree: dirty
- Status lines:
  - ` M guardian/cognition/prompts.py`
...
- Files changed: `frontend/src/features/workspace/__tests__/WorkspaceDrawer.test.tsx`, `frontend/src/features/workspace/__tests__/WorkspaceScratchpadPanel.test.tsx`, `frontend/src/features/workspace/components/WorkspaceDrawer.tsx`, `frontend/src/features/workspace/components/WorkspaceScratchpadPanel.tsx`, `frontend/src/features/workspace/state/useWorkspaceScratchpadState.ts`, `frontend/src/components/persona/layout/AppShell.tsx`, `frontend/src/components/persona/layout/__tests__/AppShell.test.tsx`, `frontend/src/features/workspace/components/WorkspaceTabs.tsx`, `frontend/src/features/workspace/state/useWorkspaceUiState.ts`, `docs/audits/daily/evening/latest.json`, `docs/audits/daily/evening/latest.md`, `docs/audits/latest.json`, `docs/audits/latest.md`, `prompts.py`, `docs/audits/daily/evening/2026-03-30-audit.json`, `docs/audits/daily/evening/2026-03-30-audit.md`, `docs/architecture/codexify_workspace_surface_spec_v_1.md`, `frontend/src/components/persona/layout/AppShell.runtimeHealth.test.tsx`, `frontend/src/components/persona/layout/GuardianChatWithSidebar.tsx`, `frontend/src/components/persona/layout/__tests__/GuardianChatWithSidebar.stability.test.tsx`, `frontend/src/contracts/supportedProfileRoutes.ts`, `frontend/src/features/chat/GuardianChat.tsx`, `frontend/src/features/chat/__tests__/useAgentRuns.test.tsx`, `frontend/src/features/chat/hooks/useAgentRuns.ts`, `frontend/src/features/chat/hooks/useGuardianActionCenter.ts`, `frontend/src/features/chat/hooks/useGuardianApprovalInbox.ts`, `frontend/src/features/connectors/useConnectors.test.tsx`, `frontend/src/features/connectors/useConnectors.ts`, `frontend/src/features/settings/SettingsView.tsx`, `frontend/src/features/settings/__tests__/SettingsView.profile-awareness.test.tsx`, `frontend/src/imprint/useImprintZero.ts`, `frontend/src/lib/runtimeRouteCapabilities.test.tsx`, `frontend/src/lib/runtimeRouteCapabilities.ts`, `frontend/src/vitest.config.ts`, `frontend/src/components/sidebar/ThreadList.tsx`, `frontend/src/components/sidebar/__tests__/ThreadList.test.tsx`, `frontend/src/App.tsx`, `frontend/src/components/documents/DocumentsView.tsx`, `frontend/src/features/workspace/__tests__/WorkspaceInvocation.test.tsx`, `frontend/src/features/workspace/state/useWorkspaceState.ts`, `frontend/src/components/documents/DocumentTile.tsx`, `frontend/src/components/media/MediaTile.test.tsx`, `frontend/src/features/workspace/WorkspaceViewer.tsx`, `frontend/src/features/workspace/__tests__/WorkspacePreview.test.tsx`, `frontend/src/components/dashboard/DashboardView.demo-state.test.tsx`, `frontend/src/components/dashboard/DashboardView.tsx`, `frontend/src/components/documents/DocumentsView.demo-state.test.tsx`, `tests/routes/test_media_routes.py`, `frontend/src/features/settings/SettingsView.test.tsx`, `guardian/server/app.py`, `tests/routes/test_imprint_routes.py`, `tests/routes/test_projects_routes.py`, `frontend/src/components/sidebar/SidebarRoot.tsx`, `frontend/src/components/sidebar/__tests__/CreateProjectModal.test.tsx`, `guardian/routes/health.py`, `tests/routes/test_health_endpoints.py`, `docs/audits/daily/morning/2026-03-30-audit.json`, `docs/audits/daily/morning/2026-03-30-audit.md`, `docs/audits/daily/morning/latest.json`, `docs/audits/daily/morning/latest.md`

| SHA | Subject | Files |
| --- | --- | --- |
| `8228f4f284bf` | feat(workspace): add per-thread scratchpad staging | `frontend/src/features/workspace/__tests__/WorkspaceDrawer.test.tsx`, `frontend/src/features/workspace/__tests__/WorkspaceScratchpadPanel.test.tsx`, `frontend/src/features/workspace/components/WorkspaceDrawer.tsx`, `frontend/src/features/workspace/components/WorkspaceScratchpadPanel.tsx`, `frontend/src/features/workspace/state/useWorkspaceScratchpadState.ts` |
| `93c5b34b66e3` | feat(workspace): add shell scaffold and persisted tabs | `frontend/src/components/persona/layout/AppShell.tsx`, `frontend/src/components/persona/layout/__tests__/AppShell.test.tsx`, `frontend/src/features/workspace/__tests__/WorkspaceDrawer.test.tsx`, `frontend/src/features/workspace/components/WorkspaceDrawer.tsx`, `frontend/src/features/workspace/components/WorkspaceTabs.tsx`, `frontend/src/features/workspace/state/useWorkspaceUiState.ts` |
| `bdb09774fbb5` | Refresh evening audit snapshot | `docs/audits/daily/evening/latest.json`, `docs/audits/daily/evening/latest.md`, `docs/audits/latest.json`, `docs/audits/latest.md`, `prompts.py` |
| `7f39d88199e6` | docs: add evening audit snapshot | `docs/audits/daily/evening/2026-03-30-audit.json`, `docs/audits/daily/evening/2026-03-30-audit.md` |
| `961e9092a06e` | Workspace Spec | `docs/architecture/codexify_workspace_surface_spec_v_1.md` |
| `e970451c56f8` | Adapt restricted-profile UI to mounted runtime capabilities | `frontend/src/components/persona/layout/AppShell.runtimeHealth.test.tsx`, `frontend/src/components/persona/layout/AppShell.tsx`, `frontend/src/components/persona/layout/GuardianChatWithSidebar.tsx`, `frontend/src/components/persona/layout/__tests__/AppShell.test.tsx`, `frontend/src/components/persona/layout/__tests__/GuardianChatWithSidebar.stability.test.tsx`, `frontend/src/contracts/supportedProfileRoutes.ts`, `frontend/src/features/chat/GuardianChat.tsx`, `frontend/src/features/chat/__tests__/useAgentRuns.test.tsx`, `frontend/src/features/chat/hooks/useAgentRuns.ts`, `frontend/src/features/chat/hooks/useGuardianActionCenter.ts`, `frontend/src/features/chat/hooks/useGuardianApprovalInbox.ts`, `frontend/src/features/connectors/useConnectors.test.tsx`, `frontend/src/features/connectors/useConnectors.ts`, `frontend/src/features/settings/SettingsView.tsx`, `frontend/src/features/settings/__tests__/SettingsView.profile-awareness.test.tsx`, `frontend/src/imprint/useImprintZero.ts`, `frontend/src/lib/runtimeRouteCapabilities.test.tsx`, `frontend/src/lib/runtimeRouteCapabilities.ts`, `frontend/src/vitest.config.ts` |
...
| `audit` | 10 | `docs/audits/daily/evening/latest.json`, `docs/audits/daily/evening/latest.md`, `docs/audits/latest.json`, `docs/audits/latest.md`, `docs/audits/daily/evening/2026-03-30-audit.json`, `docs/audits/daily/evening/2026-03-30-audit.md`, `docs/audits/daily/morning/2026-03-30-audit.json`, `docs/audits/daily/morning/2026-03-30-audit.md`, `docs/audits/daily/morning/latest.json`, `docs/audits/daily/morning/latest.md` |
| `frontend` | 42 | `frontend/src/features/workspace/__tests__/WorkspaceDrawer.test.tsx`, `frontend/src/features/workspace/__tests__/WorkspaceScratchpadPanel.test.tsx`, `frontend/src/features/workspace/components/WorkspaceDrawer.tsx`, `frontend/src/features/workspace/components/WorkspaceScratchpadPanel.tsx`, `frontend/src/features/workspace/state/useWorkspaceScratchpadState.ts`, `frontend/src/components/persona/layout/AppShell.tsx`, `frontend/src/components/persona/layout/__tests__/AppShell.test.tsx`, `frontend/src/features/workspace/components/WorkspaceTabs.tsx`, `frontend/src/features/workspace/state/useWorkspaceUiState.ts`, `frontend/src/components/persona/layout/AppShell.runtimeHealth.test.tsx`, `frontend/src/components/persona/layout/GuardianChatWithSidebar.tsx`, `frontend/src/components/persona/layout/__tests__/GuardianChatWithSidebar.stability.test.tsx`, `frontend/src/contracts/supportedProfileRoutes.ts`, `frontend/src/features/chat/GuardianChat.tsx`, `frontend/src/features/chat/__tests__/useAgentRuns.test.tsx`, `frontend/src/features/chat/hooks/useAgentRuns.ts`, `frontend/src/features/chat/hooks/useGuardianActionCenter.ts`, `frontend/src/features/chat/hooks/useGuardianApprovalInbox.ts`, `frontend/src/features/connectors/useConnectors.test.tsx`, `frontend/src/features/connectors/useConnectors.ts`, `frontend/src/features/settings/SettingsView.tsx`, `frontend/src/features/settings/__tests__/SettingsView.profile-awareness.test.tsx`, `frontend/src/imprint/useImprintZero.ts`, `frontend/src/lib/runtimeRouteCapabilities.test.tsx`, `frontend/src/lib/runtimeRouteCapabilities.ts`, `frontend/src/vitest.config.ts`, `frontend/src/components/sidebar/ThreadList.tsx`, `frontend/src/components/sidebar/__tests__/ThreadList.test.tsx`, `frontend/src/App.tsx`, `frontend/src/components/documents/DocumentsView.tsx`, `frontend/src/features/workspace/__tests__/WorkspaceInvocation.test.tsx`, `frontend/src/features/workspace/state/useWorkspaceState.ts`, `frontend/src/components/documents/DocumentTile.tsx`, `frontend/src/components/media/MediaTile.test.tsx`, `frontend/src/features/workspace/WorkspaceViewer.tsx`, `frontend/src/features/workspace/__tests__/WorkspacePreview.test.tsx`, `frontend/src/components/dashboard/DashboardView.demo-state.test.tsx`, `frontend/src/components/dashboard/DashboardView.tsx`, `frontend/src/components/documents/DocumentsView.demo-state.test.tsx`, `frontend/src/features/settings/SettingsView.test.tsx`, `frontend/src/components/sidebar/SidebarRoot.tsx`, `frontend/src/components/sidebar/__tests__/CreateProjectModal.test.tsx` |
