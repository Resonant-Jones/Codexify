...
- [Unity Audit Doctrine](./unity-audit-doctrine.md): doctrine-first coherence and synthesis layer across runtime truth, contracts, governance, operator surfaces, extension boundaries, and narrative readiness. It does not claim an implemented scoring or governance engine and does not override `00-current-state.md`.
