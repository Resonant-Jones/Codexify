...
- [Guardian Role and Delegation Boundary](./guardian-role-and-delegation-boundary.md): docs-only contract for Guardian Directory, Guardian Role, Guardian Composite, and Guardian-operative delegated harness semantics. It does not implement docs ingestion, codebase indexing, Pi/Codex/Claude execution, or release support.
