...
- [Build Proposal Artifact Contract](./build-proposal-artifact-contract.md): canonical review artifact between diagnosis and execution in the Guardian Build Loop. It defines draft proposal shape, review gating, execution eligibility, and proof attachment without claiming autonomous execution.
