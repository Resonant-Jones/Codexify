...
48. [[054-vaultnode-soft-serve-local-forge-and-github-publication-remote|ADR-054 VaultNode Soft Serve Local Forge and GitHub Publication Remote]] — optional VaultNode Soft Serve development forge, explicit GitHub publication boundary, private exposure defaults, service-state backup doctrine, and failure isolation; does not widen the supported Codexify runtime.
...
- [[054-vaultnode-soft-serve-local-forge-and-github-publication-remote|ADR-054 VaultNode Soft Serve Local Forge and GitHub Publication Remote]]
  - Governs the optional VaultNode Soft Serve local development forge, explicit remote naming transition, GitHub publication boundary, private exposure defaults, service-state backup semantics, and isolation from the supported Codexify Compose runtime.
  - Related anchors: [[041-vaultnode-canonical-machine-and-audit-authority|ADR-041 VaultNode Canonical Machine and Audit Authority]], [[../00-current-state|00 Current State]], [[../config-and-ops|Config and Ops]], and [[../../Ops/SOFT_SERVE_VAULTNODE_RUNBOOK|VaultNode Soft Serve Local Forge Runbook]].
