...
- [[056-document-lifecycle-graph-control-plane|ADR-056 Document Lifecycle Graph Control Plane]]
  - Proposes a Git-backed, schema-governed document property graph, scoped authority resolution, and bounded Agent Reading Packets. It does not migrate the corpus, implement retrieval or runtime ingestion, create an external canonical store, or widen release claims.
