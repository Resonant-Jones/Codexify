...
- [[057-product-architecture-ontology-dlg-integration|ADR-057 Product Architecture Ontology as a DLG Extension]]
  - Proposed architecture defining the Product Architecture Ontology as a versioned vocabulary and assertion layer that extends the accepted DLG. Defines stable product-program, capability, client-surface, adapater-family, and source-subsystem identities, typed relationship predicates, dependency-direction doctrine, posture and relationship assertion models, and derived projection rules. It does not create an independent product-lane registry, repository-wide classification, current relationship corpus, or runtime/release change.
