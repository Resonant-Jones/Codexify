...
47. [[055-orthogonal-ui-material-personalization|ADR-055 Orthogonal UI Material Personalization]] — governing decision for additive material axes, cross-theme Surface Temperature, light-only Paper Tone, separate persistence responsibilities, and accessibility-bounded user material expression.
