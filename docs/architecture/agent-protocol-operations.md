...
### Guardian Work Brief reporting artifacts
- Packet files generated by `make guardian-brief` are local reporting artifacts; their generated filenames are ignored through [`docs/guardian/work-briefs/.gitignore`](../guardian/work-briefs/.gitignore).
- Deliberate classification, audit, and follow-through documents in dated work-brief folders remain trackable when an explicit task selects them.
- Ignored generated reports are not runtime proof and do not widen release claims.
