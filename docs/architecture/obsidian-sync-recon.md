...
- From the same rebuild context: warmup reported a timeout against local model `qwen3.5:27b` at `http://host.docker.internal:11434/api/chat`. This is a model warmup signal only, not a knowledge-source readiness signal.
