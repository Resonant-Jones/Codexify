...
- Accepted ADR-058 separating canonical Persona Profile authored authority from Imprint relational/presentation ownership; legacy Persona observation/status and remaining frontend/inspector convergence remain unfinished, and no Beta/support claim changed.
