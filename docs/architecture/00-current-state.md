...
- Restored the deployed Watchdog migration lineage in source and proved clean, sibling, and backup-derived disposable-database convergence with the Connections sibling. The qualifying live database deliberately remains at 6e9f0a1b2c3; a separately authorized canonical live migration is the next proof, and Google OAuth remains unattempted.
