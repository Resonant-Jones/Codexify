...
- Accepted ADR-058 separating canonical Persona Profile authored authority from Imprint relational/presentation ownership; legacy Persona mutation through `/api/imprint/persona`, observation/status, and remaining frontend/inspector convergence remain unfinished, and no Beta/support claim changed.
...
- Do not treat ADR-058 acceptance as legacy Persona removal, retirement of `/api/imprint/persona`, Settings or Persona Studio convergence, inspector consolidation, Default Guardian Profile semantics, or a Beta/support expansion.
