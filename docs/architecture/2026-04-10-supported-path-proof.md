...
{"ok":true,"status":"healthy","redis":"ok",
 ...
 "model_resolution":{"model":"qwen3.5:9b","endpoint_resolution":{
   "selected_endpoint":{"base_url":"http://host.docker.internal:11434"}}}}
```
...
{"id":"local","displayName":"Local","enabled":true,"authorized":true,"available":true,
 ...
 "source":{"kind":"local","baseUrl":"http://host.docker.internal:11434"},
...
**Reconciliation:** All surfaces agree on provider=`local`, model=`qwen3.5:9b`, Ollama endpoint at `host.docker.internal:11434`. No contradictions found.
...
- Worker picked up task, called Ollama at `host.docker.internal:11434`
