# Review Notes: CAMPAIGN_2026_05_11_MARKETING_V1
...
- [risk_or_blocker] [implemented] Restore the missing worker runtime artifact or image layer that provides /app/codex_runner/src/agent-wrapper.js. (`docs/Campaign/CAMPAIGN_2026-05-01_001_PI_CODER_INTEGRATION_EXECUTION_LOG.md`)
- [risk_or_blocker] [implemented] task.failed events are emitted, but agent_runs.status remains queued. (`docs/Campaign/CAMPAIGN_2026-05-01_001_PI_CODER_INTEGRATION_EXECUTION_LOG.md`)
