...
- **Campaign index (this file):**
  - `docs/work/campaigns/chunks/CHUNK_CAMPAIGN_2026_02_17/CHUNK_CAMPAIGN_2026_02_17_CHUNKPAIGN.md`

- **Individual task files (one task per file):**
  - Directory: `docs/work/tasks/chunks/CHUNK_CAMPAIGN_2026_02_17/`
...
### Execution rule
Codex should **create each TASK as its own markdown file** under `docs/work/tasks/chunks/CHUNK_CAMPAIGN_2026_02_17/` and keep this document as the **index** that links to those task files.
...
Codex should **create the individual task files** under `docs/work/tasks/chunks/CHUNK_CAMPAIGN_2026_02_17/` (one task per file) and keep this document as the **campaign index**.
...
🧩 Task Description
This change belongs in /docs/reference/security/INCIDENT_RESPONSE.md and /scripts/security/ because it establishes the repeatable playbook and scripts for secret incident response (rotation + history rewrite + scanning).

Create these files:
 • docs/reference/security/INCIDENT_RESPONSE.md
...
git add docs/reference/security/INCIDENT_RESPONSE.md scripts/security/scan_secrets.sh scripts/security/rewrite_history_remove_paths.sh
...
🧩 Task Description
This change belongs in /.gitignore and /docs/reference/security/ because you need both prevention (ignore) and policy (documented forbidden paths).

Files in scope:
 • .gitignore
 • docs/reference/security/INCIDENT_RESPONSE.md (append a “Forbidden Paths” section)
...
git add .gitignore docs/reference/security/INCIDENT_RESPONSE.md
