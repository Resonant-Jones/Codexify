...
This slice is complete when:
 ...
 • Tests pass for each atomic task, and each task has a docs/work/tasks/... artifact with both hashes (two-phase mode).

⸻

# TASK-2026-01-16-001 — Sidebar dismiss chevron truly collapses sidebar

Task artifact: docs/work/tasks/2026/01/TASK_2026_01_16_001_sidebar_toggle.md
...
Task artifact: docs/work/tasks/2026/01/TASK_2026_01_16_002_sidebar_tab_persistence.md
Commit mode: two-phase
Allowed files:
...
Task artifact: docs/work/tasks/2026/01/TASK_2026_01_16_003_fix_glass_corner_bleed.md
Commit mode: two-phase
Allowed files:
...
Task artifact: docs/work/tasks/2026/01/TASK_2026_01_16_004_dedupe_loose_threads.md
Commit mode: two-phase
Allowed files:
...
Task artifact: docs/work/tasks/2026/01/TASK_2026_01_16_005_create_project_modal.md
Commit mode: two-phase
...
Task artifact: docs/work/tasks/2026/01/TASK_2026_01_16_006_create_project_modal_tests.md
Commit mode: two-phase
