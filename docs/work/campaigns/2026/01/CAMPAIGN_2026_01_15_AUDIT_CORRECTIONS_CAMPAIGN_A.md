...
- **Source audit:** `docs/work/reports/AUDIT_2026_01_14.md`
...
## Task Index
Each task is recorded as its own prompt+summary artifact under `docs/work/tasks/`.

> Naming convention used below:
> - Task file: `docs/work/tasks/2026/01/TASK_2026_01_15_XXX_<slug>.md`
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_001_remove_api_bypass.md`
- **Primary files:**
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_002_auth_chat_routes.md`
- **Primary files:**
  - `guardian/routes/chat.py`
- **Test loop:**
  ```bash
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_003_auth_memory_routes.md`
- **Primary files:**
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_004_auth_media_routes.md`
- **Primary files:**
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_005_gate_devtools.md`
- **Primary files:**
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_006_fail_closed_cloud_providers.md`
- **Primary files:**
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_007_wire_guardiandb.md`
- **Primary files:**
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_008_rag_injection_worker.md`
- **Primary files:**
  - `guardian/workers/chat_worker.py`
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_009_remove_frontend_key_injection.md`
- **Primary files:**
  - `docker-compose.yml`
...
- **Task file:** `docs/work/tasks/2026/01/TASK_2026_01_15_010_route_inventory_script.md`
- **Primary files:**
...
- All tasks above have:
  ...
  - a filled `docs/work/tasks/...` artifact containing prompt + summary + commit hash.
- A follow-up audit is produced at:
  - `docs/work/reports/AUDIT_2026_01_15_post_campaign.md`
