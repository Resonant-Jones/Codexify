...
2. Ensure the corresponding artifact file exists under `docs/work/tasks/2026/02/TASK_2026_02_16_<NN>_<slug>.md` (create if missing, using the campaign’s naming convention).
...
- **Canonical:** This file (`docs/work/campaigns/2026/02/CAMPAIGN_2026_02_16_HARDENING_SECURITY.md`)
...
|---|-----------|--------------|
| 1 | Single User Identity Contract | docs/archive/tasks/legacy/TASK_2026_02_16_01_single_user_identity_contract.md |
| 2 | Lock Down Egress by Default | docs/archive/tasks/legacy/TASK_2026_02_16_02_lock_down_egress_by_default.md |
| 3 | Namespace Vector Retrieval Single User | docs/archive/tasks/legacy/TASK_2026_02_16_03_namespace_vector_retrieval_single_user.md |
| 4 | Config Unification or Startup Assertions | docs/archive/tasks/legacy/TASK_2026_02_16_04_config_unification_or_startup_assertions.md |
| 5 | Federation Guardrails | docs/archive/tasks/legacy/TASK_2026_02_16_05_federation_guardrails.md |
| 6 | Plugin Loader Consolidation | docs/archive/tasks/legacy/TASK_2026_02_16_06_plugin_loader_consolidation.md |
| 7 | Docs Alignment for Security Posture | docs/archive/tasks/legacy/TASK_2026_02_16_07_docs_alignment_for_security_posture.md |
| 8 | Outbox Delivery Safety Review | docs/archive/tasks/legacy/TASK_2026_02_16_08_outbox_delivery_safety_review.md |
| 9 | Offline Banner Provider Reroute | docs/archive/tasks/legacy/TASK_2026_02_16_09_offline_banner_provider_reroute.md |
