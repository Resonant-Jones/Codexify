...
## Task Index
> Each task has an existing task artifact in `docs/work/tasks/`.
...
1. TASK-2026-02-15-01_iddb_layer_enforcement
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_01_iddb_layer_enforcement.md`
   - Task mapping: `TASK-2026-02-15-01_iddb_layer_enforcement -> [717adcc3, <commitB>]`

2. TASK-2026-02-15-02_flow_authentication_boundary
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_02_flow_authentication_boundary.md`
...
3. TASK-2026-02-15-03_cli_sandboxed_project_execution
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_03_cli_sandboxed_project_execution.md`
...
4. TASK-2026-02-15-04_modular_system_prompt_builder
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_04_modular_system_prompt_builder.md`
...
5. TASK-2026-02-15-05_persistent_imprint_persona_storage
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_05_persistent_imprint_persona_storage.md`
...
6. TASK-2026-02-15-06_event_graph_emission
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_06_event_graph_emission.md`
...
7. TASK-2026-02-15-07_codex_entry_lineage_enforcement
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_07_codex_entry_lineage_enforcement.md`
...
8. TASK-2026-02-15-08_token_cost_ui_warning
   - Task artifact: `docs/archive/tasks/legacy/TASK_2026_02_15_08_token_cost_ui_warning.md`
