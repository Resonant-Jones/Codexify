...
- Follow docs/reference/operator/ops/Runner_Protocol.md two-phase commit pattern:
...
- docs/work/tasks/2026/01/TASK_2026_01_20_001_chat_endpoint_canonicalization.md
...
1) Create/update docs/work/tasks/2026/01/TASK_2026_01_20_001_chat_endpoint_canonicalization.md including:
...
2) git add docs/work/tasks/2026/01/TASK_2026_01_20_001_chat_endpoint_canonicalization.md
...
- **Task prompt artifact filename (underscore form):** `docs/work/tasks/YYYY/MM/TASK_YYYY_MM_DD_NNN_<lowercase_slug>.md`
...
- **Campaign stack filename (underscore form):** `docs/work/campaigns/YYYY/MM/CAMPAIGN_YYYY_MM_DD.md`
  - Example: `docs/work/campaigns/2026/01/CAMPAIGN_2026_01_20.md`

Rules:
- Campaign files live under `docs/work/campaigns/` (capital C).
