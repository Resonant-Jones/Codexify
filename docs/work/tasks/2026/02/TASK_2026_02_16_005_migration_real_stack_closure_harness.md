...
- Rollback / cleanup commands:
  - git restore --staged --worktree -- scripts/verification/migration_loop_validation.sh docs/reference/guardian/migration_loop_validation.md tests/routes/test_migration_routes.py guardian/guardian_api.py guardian/routes/migration.py docs/work/reports/mvp-core-loop-closure-matrix.md
  - git status --porcelain -uall