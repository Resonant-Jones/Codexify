...
- `docs/reference/guardian/control-plane.md`
- `scripts/verification/e2e_control_plane_checklist.sh`
- `scripts/verification/README.md`
- This task artifact: `docs/work/tasks/2026/02/TASK_2026_02_06_016_end_to_end_verification_script_docs.md`
- Campaign mapping doc(s):
  - `docs/work/campaigns/2026/02/CAMPAIGN_2026_02_06_GUARDIAN_PARITY_CONTROL_PLANE.md`
  - `docs/work/campaigns/2026/02/CAMPAIGN_2026_02_06_LOOP_INTEGRITY_AUTH_AND_DEFAULTS.md`
...
ls -la docs/reference/guardian/control-plane.md scripts/verification/e2e_control_plane_checklist.sh scripts/verification/README.md
...
rg -n "TODO\(|TODO:|TBD" docs/reference/guardian/control-plane.md scripts/verification/README.md scripts/verification/e2e_control_plane_checklist.sh || true
```
...
git restore -- docs/reference/guardian/control-plane.md \
  scripts/verification/e2e_control_plane_checklist.sh \
  scripts/verification/README.md \
  docs/work/tasks/2026/02/TASK_2026_02_06_016_end_to_end_verification_script_docs.md \
  docs/work/campaigns/2026/02/CAMPAIGN_2026_02_06_GUARDIAN_PARITY_CONTROL_PLANE.md \
  docs/work/campaigns/2026/02/CAMPAIGN_2026_02_06_LOOP_INTEGRITY_AUTH_AND_DEFAULTS.md
...
- **Commands run + outcomes:**
  - `ls -la docs/reference/guardian/control-plane.md scripts/verification/e2e_control_plane_checklist.sh scripts/verification/README.md` -> pass
  - `chmod +x scripts/verification/e2e_control_plane_checklist.sh` -> pass
  - `rg -n "TODO\\(|TODO:|TBD" docs/reference/guardian/control-plane.md scripts/verification/README.md scripts/verification/e2e_control_plane_checklist.sh || true` -> no TODO/TBD markers
