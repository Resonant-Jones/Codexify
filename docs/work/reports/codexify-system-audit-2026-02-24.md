...
- Legacy docs still reference `Loose Threads` default project semantics (example `/Users/resonant_jones/.codex/worktrees/ae18/Codexify/docs/work/plans/roadmaps/09-18-25-dailytasks.md:6`).
