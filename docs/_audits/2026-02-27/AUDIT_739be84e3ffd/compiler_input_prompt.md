...
- Stage-A audit JSON: {
  "audit_id": "AUDIT_739be84e3ffd",
  "repo": {
    "path": "/Users/resonant_jones/Keep/Resonant_Constructs/Codexify",
    "branch": "rescue/phase2-20260226-004130",
    "commit": "76d87c9096f080166763b0890a0b320abed9303d"
  },
  "generated_at": "2026-02-27T22:16:38Z",
  "agent": {
    "name": "Codex",
    "model": "gpt-5.3-codex",
    "mode": "audit"
  ...
  "runner_ready_findings": [
    {
      ...
      "evidence": [
        {
          "file": "docs/_audits/2026-02-27/AUDIT_739be84e3ffd/audit_input_prompt.md",
          "lines": "untracked"
        },
        {
          "file": "docs/_audits/2026-02-27/AUDIT_739be84e3ffd/run_inputs.json",
          "lines": "untracked"
        },
        {
      ...
      "suggested_commands": [
        ...
        "git stash push -u -m preflight-AUDIT_739be84e3ffd",
        "git status --porcelain -uall"
      ],
      "dependencies": [],
