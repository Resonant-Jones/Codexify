...
## Task Prompt
- **Context:** Package the personal facts and message guard backend feature slice in the local Codexify repo while following `docs/reference/operator/ops/Runner_Protocol.md`.
