...
- Branch: `main`
- HEAD: `9b7cc2703a77`
- Upstream: origin/main; ahead 1, behind 16
...
## main...origin/main [ahead 1, behind 16]
 M Makefile
 M docs/guardian/work-briefs/latest-truth-ledger.json
?? docs/guardian/work-briefs/README.md
?? scripts/guardian/generate_work_brief.py
?? tests/scripts/test_generate_work_brief.py
```
