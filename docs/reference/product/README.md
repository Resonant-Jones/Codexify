...
- [Plugin Development Guide](../plugins/plugin_development.md)
...
Examples directory
- JSON array template: `docs/reference/operator/examples/gdrive_records.json`
- NDJSON template: `docs/reference/operator/examples/gdrive_records.ndjson`
