...
Source anchors:
- `README.md`
- `docs/reference/operator/help/CODEXIFY_HELP_AND_FAQ.md`
...
- `docs/reference/guardian/command-bus-auth-cli-automations.md`
...
|---|---|---|---|---|---|
| UI | React app shell, API client wiring, route/view rendering | `frontend/src/App.tsx`, `frontend/src/lib/api.ts`, `docs/reference/operator/ui/UI-DESIGN-MAP.md` | You | medium | `docker compose logs --tail=120 frontend` |
...
| Ops | Compose topology, env wiring, service-level diagnostics | `docker-compose.yml`, `.env.template`, `README.md`, `docs/reference/architecture/config-and-ops.md` | You | high | `docker compose ps` |
