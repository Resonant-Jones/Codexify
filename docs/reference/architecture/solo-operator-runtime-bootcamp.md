...
Source anchors:
- `docs/reference/operator/ops/SOLO_OPERATOR_SYSTEM_MAP.md`
- `docs/reference/operator/ops/SOLO_OPERATOR_AUTOMATION_RUNBOOK.md`
- `docs/reference/operator/ops/SOLO_OPERATOR_FAILURE_SIGNATURES.md`
...
1. System map: `docs/reference/operator/ops/SOLO_OPERATOR_SYSTEM_MAP.md`
2. Automation runbook: `docs/reference/operator/ops/SOLO_OPERATOR_AUTOMATION_RUNBOOK.md`
3. Failure signatures page: `docs/reference/operator/ops/SOLO_OPERATOR_FAILURE_SIGNATURES.md`
...
2. Keep failure signatures current in `docs/reference/operator/ops/SOLO_OPERATOR_FAILURE_SIGNATURES.md`.
...
- Daily loop details: `docs/reference/operator/ops/SOLO_OPERATOR_AUTOMATION_RUNBOOK.md`
- Weekly loop details: `docs/reference/operator/ops/SOLO_OPERATOR_AUTOMATION_RUNBOOK.md`
