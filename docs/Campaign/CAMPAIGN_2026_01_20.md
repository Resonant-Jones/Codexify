...
- Task artifact (to be created): `docs/tasks/TASK_2026_01_20_013_document_gen_modal_ui.md`
...
Files allowed to edit (only)
- `frontend/src/components/DocumentGenModal.tsx` (new)
- `frontend/src/components/AppShell.tsx`
- `frontend/src/components/Sidebar.tsx`
- `frontend/src/App.tsx`
- `frontend/src/tests/document_gen_modal.spec.tsx` (new)
