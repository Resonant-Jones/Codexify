...
| C04-T015 | backend | `go` | `408ddee88` | Route includes operator_evidence via build_operator_evidence_from_dry_run_response() |
| C04-T016 | frontend | `go` | `825e7c773` | Render operator_evidence — read-only evidence fields and boundary copy in validation card |
