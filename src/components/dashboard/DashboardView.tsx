...
<div className="grid h-full min-h-0 grid-cols-2 gap-3 items-stretch">
      {/* Column 1: Pinned / Recent */}
      <div className="glass-surface rounded-2xl p-[3px] h-full">
        <div
        ...
        >
          ...
          <div className="min-h-0 flex-1 overflow-auto p-4 pt-0">
            <div className="text-lg font-semibold mb-3">Recent Documents</div>
